                                ...
                                <div class="container mb-5">
                                    <div class="table-responsive">
                                        ...
                                        foreach ($tampil as $row) {
                                            ...
                                            echo "<td class='text-center'><a href='paket.php?op=update&id=$row[id_paket]'><i class='bi bi-pencil-fill'></i></a> <a href='paket.php?op=delete&id=$row[id_paket]'><i class='bi bi-trash-fill'></i></a></td>";
                                            echo "</tr>";
                                            $i++;
                                        }
                                        echo "</tbody>";
